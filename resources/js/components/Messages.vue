                            ...
                            >
                                <div class="chat_people">
                                    ...
                                    <div class="chat_ib">
                                        ...
                                        <p
                                            v-for="role in privateMsg.roles"
                                            :key="role.id"
                                        >
                                            {{ role.name }}
                                        </p>
...
export default {
    ...
    mounted() {
        Echo.private("domowyserwis").listen("MessageSent", e => {
            this.singleMsgs.push(e.message);
        });
    },
    created() {
        this.loadMessages();
